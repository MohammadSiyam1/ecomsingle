...
@section('title', 'Dashboard | Pending Orders')
@section('body')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pages/</span> All Pending Orders</h4>
        <div class="card">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($pendingOrders as $order)
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('admin.storeToConfirmOrder',$order->id)}}" method="post">
                                        @csrf
