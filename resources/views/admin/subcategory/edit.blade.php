        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            @if ($errors->any())
                    ...
                    @endif
            <form method="POST" action="{{route('admin.updateSubCategory',$sub_category->id)}}">
                @csrf
                @method('PUT')
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="subCategory">Sub Category Name</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="subCategory" name="subCategory" value="{{$sub_category->sub_category_name}}">
                </div>
              </div>
